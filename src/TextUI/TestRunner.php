 ...
 * PHP SAPI Module.
 */
class \PHPUnit\TextUI\TestRunner extends \PHPUnit\Runner\BaseTestRunner
{
     ...
     */
    public function __construct(\PHPUnit\Runner\TestSuiteLoader $loader = null, CodeCoverageFilter $filter = null)
    {
        if ($filter === null) {
    ...
    public function doRun(\PHPUnit\Framework\Test $suite, array $arguments = [], $exit = true)
    {
        ...
        if (is_int($arguments['repeat'])) {
            $test = new \PHPUnit\Extensions\RepeatedTest(
                $suite,
                $arguments['repeat'],
        ...
        if ($this->printer === null) {
            if (isset($arguments['printer']) &&
                ...
                if (isset($arguments['printer']) &&
                    ...
                    if ($class->isSubclassOf('\PHPUnit\TextUI\ResultPrinter')) {
        ...
        if (!$this->printer instanceof \PHPUnit\Util\Log\TAP) {
            $this->printer->write(
        ...
        if (isset($arguments['testdoxHTMLFile'])) {
            $result->addListener(
                new \PHPUnit\Util\TestDox\ResultPrinter\HTML(
        ...
        if (isset($arguments['testdoxTextFile'])) {
            $result->addListener(
                new \PHPUnit\Util\TestDox\ResultPrinter\Text(
        ...
        if (isset($arguments['testdoxXMLFile'])) {
            $result->addListener(
                new \PHPUnit\Util\TestDox\ResultPrinter\XML(
        ...
        if (isset($arguments['jsonLogfile'])) {
            $result->addListener(
                new \PHPUnit\Util\Log\JSON($arguments['jsonLogfile'])
            );
        }

        if (isset($arguments['tapLogfile'])) {
            $result->addListener(
                new \PHPUnit\Util\Log\TAP($arguments['tapLogfile'])
            );
        }

        if (isset($arguments['teamcityLogfile'])) {
            $result->addListener(
                new \PHPUnit\Util\Log\TeamCity($arguments['teamcityLogfile'])
            );
        }

        if (isset($arguments['junitLogfile'])) {
            $result->addListener(
                new \PHPUnit\Util\Log\JUnit(
    ...
    /**
     * @param \PHPUnit\TextUI\ResultPrinter $resultPrinter
     */
    ...
    {
        if (isset($arguments['configuration']) &&
            !$arguments['configuration'] instanceof \PHPUnit\Util\Configuration) {
            $arguments['configuration'] = \PHPUnit\Util\Configuration::getInstance(
        ...
        if (isset($arguments['configuration'])) {
            ...
            if (isset($loggingConfiguration['plain'])) {
                $arguments['listeners'][] = new \PHPUnit\TextUI\ResultPrinter(
        ...
        $arguments['colors']                                          = isset($arguments['colors'])                                          ? $arguments['colors']                                          : \PHPUnit\TextUI\ResultPrinter::COLOR_DEFAULT;
