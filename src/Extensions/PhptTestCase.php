 ...
 */
class \PHPUnit\Extensions\PhptTestCase implements \PHPUnit\Framework\Test, \PHPUnit\Framework\SelfDescribing
{
    /**
     * @var string
     */
    ...
    public function __construct($filename, $phpUtil = null)
    {
        ...
        $this->phpUtil  = $phpUtil ?: \PHPUnit\Util\PHP::factory();
    }
    ...
    private function assertPhptExpectation(array $sections, $output)
    {
        ...
        \PHPUnit\Framework\Assert::$assertion($expected, $actual);
    }
    ...
    public function run(\PHPUnit\Framework\TestResult $result = null)
    {
        ...
        if (isset($sections['SKIPIF'])) {
            ...
            if (!strncasecmp('skip', ltrim($jobResult['stdout']), 4)) {
                ...
                $result->addFailure($this, new \PHPUnit\Framework\SkippedTestError($message), 0);
        ...
        if (!$skip) {
            ...
            try {
                ...
                if ($xfail !== false) {
                    $result->addFailure(
                        $this,
                        new \PHPUnit\Framework\IncompleteTestError(
                            $xfail,
                            0,
                            $e
                        ),
    ...
    private function parse()
    {
        ...
        foreach (file($this->filename) as $line) {
            if (preg_match('/^--([_A-Z]+)--/', $line, $result)) {
                ...
                throw new \PHPUnit\Framework\Exception('Invalid PHPT file');
            }
