 ...
 */
class \PHPUnit\Framework\TestSuite implements \PHPUnit\Framework\Test, \PHPUnit\Framework\SelfDescribing, IteratorAggregate
{
    /**
    ...
    public function addTestSuite($testClass)
    {
        ...
        if ($testClass instanceof self) {
            ...
            if (!$testClass->isAbstract()) {
                if ($testClass->hasMethod(\PHPUnit\Runner\BaseTestRunner::SUITE_METHODNAME)) {
                    $method = $testClass->getMethod(
                        \PHPUnit\Runner\BaseTestRunner::SUITE_METHODNAME
                    );
    ...
    public function addTestFile($filename)
    {
        ...
        if (file_exists($filename) && substr($filename, -5) == '.phpt') {
            $this->addTest(
                new \PHPUnit\Extensions\PhptTestCase($filename)
            );
        ...
        $filename   = \PHPUnit\Util\Fileloader::checkAndLoad($filename);
        ...
        foreach ($newClasses as $className) {
            ...
            if (!$class->isAbstract()) {
                if ($class->hasMethod(\PHPUnit\Runner\BaseTestRunner::SUITE_METHODNAME)) {
    ...
    public static function createTest(ReflectionClass $theClass, $name)
    {
        ...
        if ($constructor !== null) {
            ...
            if (count($parameters) < 2) {
                ...
                if (isset($data)) {
                    $test = new \PHPUnit\Framework\TestSuite\DataProvider(
                        $className . '::' . $name
                    );
                    ...
                    if ($data instanceof \PHPUnit\Framework\WarningTestCase ||
                        $data instanceof \PHPUnit\Framework\SkippedTestCase ||
                        $data instanceof \PHPUnit\Framework\IncompleteTestCase) {
    ...
    protected function addTestMethod(ReflectionClass $class, ReflectionMethod $method)
    {
        ...
        if ($test instanceof \PHPUnit\Framework\TestCase ||
            $test instanceof \PHPUnit\Framework\TestSuite\DataProvider) {
    ...
    {
        return new \PHPUnit\Framework\WarningTestCase($message);
    }
    ...
    {
        return new \PHPUnit\Framework\SkippedTestCase($class, $methodName, $message);
    }
    ...
    {
        return new \PHPUnit\Framework\IncompleteTestCase($class, $methodName, $message);
    }
    ...
    {
        $iterator = new \PHPUnit\Util\TestSuiteIterator($this);
