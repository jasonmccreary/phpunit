 ...
 * </code>
 */
abstract class \PHPUnit\Framework\TestCase extends \PHPUnit\Framework\Assert implements \PHPUnit\Framework\Test, \PHPUnit\Framework\SelfDescribing
{
    /**
    ...
    {
        $this->status = \PHPUnit\Runner\BaseTestRunner::STATUS_RISKY;
    }
    ...
    public function hasFailed()
    {
        ...
        return $status == \PHPUnit\Runner\BaseTestRunner::STATUS_FAILURE ||
    ...
    public function run(\PHPUnit\Framework\TestResult $result = null)
    {
        ...
        if ($this->runTestInSeparateProcess === true &&
            ...
            !$this instanceof \PHPUnit\Extensions\PhptTestCase) {
            $class = new ReflectionClass($this);
    ...
    public function runBare()
    {
        ...
        try {
            ...
            $this->status        = \PHPUnit\Runner\BaseTestRunner::STATUS_WARNING;
            $this->statusMessage = $e->getMessage();
    ...
    protected function runTest()
    {
        ...
        if (isset($e)) {
            ...
            if (!($e instanceof \PHPUnit\Framework\SkippedTestError) && is_string($this->expectedException)) {
                $checkException = true;
            ...
            if ($checkException) {
                ...
                if ($this->expectedExceptionMessage !== null) {
                    $this->assertThat(
                        $e,
                        new \PHPUnit\Framework\Constraint\ExceptionMessage(
                ...
                if ($this->expectedExceptionMessageRegExp !== null) {
                    $this->assertThat(
                        $e,
                        new \PHPUnit\Framework\Constraint\ExceptionMessageRegExp(
                ...
                if ($this->expectedExceptionCode !== null) {
                    $this->assertThat(
                        $e,
                        new \PHPUnit\Framework\Constraint\ExceptionCode(
    ...
    {
        $this->warnings[] = '\PHPUnit\Framework\TestCase::getMock() is deprecated, use \PHPUnit\Framework\TestCase::createMock() or \PHPUnit\Framework\TestCase::getMockBuilder() instead';
    ...
    {
        $this->warnings[] = '\PHPUnit\Framework\TestCase::getMockWithoutInvokingTheOriginalConstructor() is deprecated, use \PHPUnit\Framework\TestCase::createMock() instead';
            ...
            foreach ($this->dependencies as $dependency) {
                ...
                if (!isset($passedKeys[$dependency])) {
                    ...
                    $this->result->addError(
                        $this,
                        new \PHPUnit\Framework\SkippedTestError(
                            sprintf(
