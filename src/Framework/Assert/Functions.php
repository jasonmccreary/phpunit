 ...
 * @param string                       $message
 */
function assertThat($value, \PHPUnit\Framework\Constraint $constraint, $message = '')
{
    return call_user_func_array(
 ...
 */
function attribute(\PHPUnit\Framework\Constraint $constraint, $attributeName)
{
    return call_user_func_array(
 ...
 */
function logicalNot(\PHPUnit\Framework\Constraint $constraint)
{
    return call_user_func_array(
