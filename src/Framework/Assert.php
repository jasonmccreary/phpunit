 ...
 */
abstract class \PHPUnit\Framework\Assert
{
    /**
     * @var int
     */
    ...
    public static function assertArrayNotHasKey($key, $array, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\ArrayHasKey($key)
        );
    ...
    public static function assertContains($needle, $haystack, $message = '', $ignoreCase = false, $checkForObjectIdentity = true, $checkForNonObjectIdentity = false)
    {
        if (is_array($haystack) ||
            ...
            $constraint = new \PHPUnit\Framework\Constraint\TraversableContains(
                $needle,
            ...
            $constraint = new \PHPUnit\Framework\Constraint\StringContains(
                $needle,
                $ignoreCase
            );
        } else {
    ...
    public static function assertContainsOnly($type, $haystack, $isNativeType = null, $message = '')
    {
        ...
        static::assertThat(
            $haystack,
            new \PHPUnit\Framework\Constraint\TraversableContainsOnly(
                $type,
                $isNativeType
            ),
            $message
    ...
    public static function assertNotContainsOnly($type, $haystack, $isNativeType = null, $message = '')
    {
        ...
        static::assertThat(
            $haystack,
            new \PHPUnit\Framework\Constraint\Not(
                new \PHPUnit\Framework\Constraint\TraversableContainsOnly(
                    $type,
                    $isNativeType
                )
    ...
    public static function assertCount($expectedCount, $haystack, $message = '')
    {
        ...
        if (!$haystack instanceof Countable &&
            ...
            !is_array($haystack)) {
            throw \PHPUnit\Util\InvalidArgumentHelper::factory(2, 'countable or traversable');
        }

        static::assertThat(
            $haystack,
            new \PHPUnit\Framework\Constraint\Count($expectedCount),
            $message
        );
    }
    ...
    public static function assertIsReadable($filename, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\IsReadable;
    ...
    public static function assertNotIsReadable($filename, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\IsReadable
        );
    ...
    public static function assertIsWritable($filename, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\IsWritable;
    ...
    public static function assertNotIsWritable($filename, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\IsWritable
        );
    ...
    public static function assertDirectoryExists($directory, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\DirectoryExists;
    ...
    public static function assertDirectoryNotExists($directory, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\DirectoryExists
        );
    ...
    public static function assertFileExists($filename, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\FileExists;
    ...
    public static function assertFileNotExists($filename, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\FileExists
        );
    ...
    public static function assertClassHasAttribute($attributeName, $className, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\ClassHasAttribute(
            $attributeName
        );
    ...
    public static function assertClassNotHasAttribute($attributeName, $className, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\ClassHasAttribute($attributeName)
        );
    ...
    public static function assertClassHasStaticAttribute($attributeName, $className, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\ClassHasStaticAttribute(
            $attributeName
        );
    ...
    public static function assertClassNotHasStaticAttribute($attributeName, $className, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\ClassHasStaticAttribute(
                $attributeName
            )
        );
    ...
    public static function assertObjectHasAttribute($attributeName, $object, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\ObjectHasAttribute(
            $attributeName
        );
    ...
    public static function assertObjectNotHasAttribute($attributeName, $object, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\ObjectHasAttribute($attributeName)
        );
    ...
    public static function assertSame($expected, $actual, $message = '')
    {
        if (is_bool($expected) && is_bool($actual)) {
            ...
            $constraint = new \PHPUnit\Framework\Constraint\IsIdentical(
                $expected
            );
    ...
    public static function assertNotSame($expected, $actual, $message = '')
    {
        if (is_bool($expected) && is_bool($actual)) {
            ...
            $constraint = new \PHPUnit\Framework\Constraint\Not(
                new \PHPUnit\Framework\Constraint\IsIdentical($expected)
            );
    ...
    public static function assertInstanceOf($expected, $actual, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\IsInstanceOf(
            $expected
        );
    ...
    public static function assertNotInstanceOf($expected, $actual, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\IsInstanceOf($expected)
        );
    ...
    public static function assertInternalType($expected, $actual, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\IsType(
            $expected
        );
    ...
    public static function assertRegExp($pattern, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\PCREMatch($pattern);
    ...
    public static function assertNotRegExp($pattern, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\PCREMatch($pattern)
        );
    ...
    public static function assertSameSize($expected, $actual, $message = '')
    {
        if (!$expected instanceof Countable &&
            ...
            !is_array($expected)) {
            throw \PHPUnit\Util\InvalidArgumentHelper::factory(1, 'countable or traversable');
        }
        ...
        static::assertThat(
            $actual,
            new \PHPUnit\Framework\Constraint\SameSize($expected),
            $message
        );
    }
    ...
    public static function assertStringMatchesFormat($format, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\StringMatches($format);
    ...
    public static function assertStringNotMatchesFormat($format, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\StringMatches($format)
        );
    ...
    public static function assertStringMatchesFormatFile($formatFile, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\StringMatches(
    ...
    public static function assertStringNotMatchesFormatFile($formatFile, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\StringMatches(
                file_get_contents($formatFile)
            )
        );
    ...
    public static function assertStringStartsWith($prefix, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\StringStartsWith(
            $prefix
        );
    ...
    public static function assertStringStartsNotWith($prefix, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\StringStartsWith($prefix)
        );
    ...
    public static function assertStringEndsWith($suffix, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\StringEndsWith($suffix);
    ...
    public static function assertStringEndsNotWith($suffix, $string, $message = '')
    {
        ...
        $constraint = new \PHPUnit\Framework\Constraint\Not(
            new \PHPUnit\Framework\Constraint\StringEndsWith($suffix)
        );
     ...
     * @param string                       $message
     */
    public static function assertThat($value, \PHPUnit\Framework\Constraint $constraint, $message = '')
    {
    ...
    public static function assertJsonStringEqualsJsonFile($expectedFile, $actualJson, $message = '')
    {
        ...
        // call constraint
        $constraint = new \PHPUnit\Framework\Constraint\JsonMatches(
            $expectedJson
        );
    ...
    public static function assertJsonStringNotEqualsJsonFile($expectedFile, $actualJson, $message = '')
    {
        ...
        static::assertThat($actualJson, new \PHPUnit\Framework\Constraint\Not($constraint), $message);
    }
    ...
    public static function assertJsonFileEqualsJsonFile($expectedFile, $actualFile, $message = '')
    {
        ...
        // call constraint
        $constraintExpected = new \PHPUnit\Framework\Constraint\JsonMatches(
            $expectedJson
        );
    ...
    public static function assertJsonFileNotEqualsJsonFile($expectedFile, $actualFile, $message = '')
    {
        ...
        static::assertThat($expectedJson, new \PHPUnit\Framework\Constraint\Not($constraintActual), $message);
        static::assertThat($actualJson, new \PHPUnit\Framework\Constraint\Not($constraintExpected), $message);
    }

    /**
     * Returns a \PHPUnit\Framework\Constraint\And matcher object.
     *
     * @return \PHPUnit\Framework\Constraint\And
     */
    public static function logicalAnd()
    {
        $constraints = func_get_args();

        $constraint = new \PHPUnit\Framework\Constraint\And;
     ...
     *
     * @return \PHPUnit\Framework\Constraint\Or
     */
    public static function logicalOr()
    {
        $constraints = func_get_args();

        $constraint = new \PHPUnit\Framework\Constraint\Or;
        $constraint->setConstraints($constraints);
     ...
     * @param \PHPUnit\Framework\Constraint $constraint
     *
     * @return \PHPUnit\Framework\Constraint\Not
     */
    public static function logicalNot(\PHPUnit\Framework\Constraint $constraint)
    {
        return new \PHPUnit\Framework\Constraint\Not($constraint);
    }

    /**
     * Returns a \PHPUnit\Framework\Constraint\Xor matcher object.
     *
     * @return \PHPUnit\Framework\Constraint\Xor
     */
    public static function logicalXor()
    {
        $constraints = func_get_args();

        $constraint = new \PHPUnit\Framework\Constraint\Xor;
        $constraint->setConstraints($constraints);
     ...
     *
     * @return \PHPUnit\Framework\Constraint\IsAnything
     */
     ...
     */
    public static function attribute(\PHPUnit\Framework\Constraint $constraint, $attributeName)
    {
        return new \PHPUnit\Framework\Constraint\Attribute(
            $constraint,
            $attributeName
        );
    }
    ...
    {
        return new \PHPUnit\Framework\Constraint\IsEqual(
            $value,
            $delta,
            $maxDepth,
            $canonicalize,
     ...
     *
     * @return \PHPUnit\Framework\Constraint\IsWritable
     */
     ...
     *
     * @return \PHPUnit\Framework\Constraint\IsReadable
     */
     ...
     *
     * @return \PHPUnit\Framework\Constraint\DirectoryExists
     */
    ...
    public static function greaterThanOrEqual($value)
    {
        return static::logicalOr(
            new \PHPUnit\Framework\Constraint\IsEqual($value),
            new \PHPUnit\Framework\Constraint\GreaterThan($value)
        );
    }
    ...
    {
        return new \PHPUnit\Framework\Constraint\ClassHasAttribute(
            $attributeName
        );
    }
    ...
    {
        return new \PHPUnit\Framework\Constraint\ClassHasStaticAttribute(
            $attributeName
        );
    }
    ...
    {
        return new \PHPUnit\Framework\Constraint\ObjectHasAttribute(
            $attributeName
        );
    }
    ...
    public static function lessThanOrEqual($value)
    {
        return static::logicalOr(
            new \PHPUnit\Framework\Constraint\IsEqual($value),
            new \PHPUnit\Framework\Constraint\LessThan($value)
        );
    }
     ...
     * @param string $pattern
     *
     * @return \PHPUnit\Framework\Constraint\PCREMatch
     */
    public static function matchesRegularExpression($pattern)
    {
        return new \PHPUnit\Framework\Constraint\PCREMatch($pattern);
    }
    ...
    {
        return new \PHPUnit\Framework\Constraint\StringMatches($string);
    }
