<?php
namespace PHPUnit\Framework\Constraint\TraversableContains.php
 ...
 * a given value.
 */
class TraversableContains extends \PHPUnit\Framework\Constraint
{
    /**
     * @var bool
     */
    ...
    public function __construct($value, $checkForObjectIdentity = true, $checkForNonObjectIdentity = false)
    {
        ...
        if (!is_bool($checkForNonObjectIdentity)) {
            throw \PHPUnit\Util\InvalidArgumentHelper::factory(3, 'boolean');
        }
