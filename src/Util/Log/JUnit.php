 ...
 */
class \PHPUnit\Util\Log\JUnit extends \PHPUnit\Util\Printer implements \PHPUnit\Framework\TestListener
{
    /**
     * @var DOMDocument
     */
    ...
    public function addIncompleteTest(\PHPUnit\Framework\Test $test, Exception $e, $time)
    {
        if ($this->logIncompleteSkipped && $this->currentTestCase !== null) {
            $error = $this->document->createElement(
                'error',
                \PHPUnit\Util\XML::prepareString(
                    "Incomplete Test\n" .
    ...
    private function doAddFault(\PHPUnit\Framework\Test $test, Exception $e, $time, $type)
    {
        ...
        $buffer .= \PHPUnit\Framework\TestFailure::exceptionToString($e) . PHP_EOL .
                   \PHPUnit\Util\Filter::getFilteredStacktrace($e);

        $fault = $this->document->createElement(
            $type,
            \PHPUnit\Util\XML::prepareString($buffer)
        );
