<?php
namespace PHPUnit\Util\Configuration.php
...
class Configuration
{
    ...
    protected function __construct($filename)
    {
        ...
        $this->document = \PHPUnit\Util\XML::loadFile($filename, false, true, true);
    ...
    public function getPHPUnitConfiguration()
    {
        ...
        if ($root->hasAttribute('colors')) {
            ...
            if ($this->getBoolean($root->getAttribute('colors'), false)) {
                $result['colors'] = \PHPUnit\TextUI\ResultPrinter::COLOR_AUTO;
            } else {
                $result['colors'] = \PHPUnit\TextUI\ResultPrinter::COLOR_NEVER;
            }
        }
