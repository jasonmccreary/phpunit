...
class CountTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $countConstraint = new \PHPUnit\Framework\Constraint\Count(3);
        $this->assertTrue($countConstraint->evaluate([1, 2, 3], '', true));

        $countConstraint = new \PHPUnit\Framework\Constraint\Count(0);
        $this->assertTrue($countConstraint->evaluate([], '', true));

        $countConstraint = new \PHPUnit\Framework\Constraint\Count(2);
    ...
    public function testCountGeneratorsDoNotRewind()
    {
        ...
        $countConstraint = new \PHPUnit\Framework\Constraint\Count(1);
